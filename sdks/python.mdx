...
- `CreateSessionParams`:
  ...
  - `screen?: ScreenConfig` - Screen configuration for the session.
    - `max_width: number` - Maximum screen width.
    - `max_height: number` - Maximum screen height.
    - `min_width: number` - Minimum screen width.
    - `min_height: number` - Minimum screen height.
